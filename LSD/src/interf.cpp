...
cmd(inter, "bind .l.v.c.var_name <Return> {set res [.l.v.c.var_name curselection]; set cur $res; if {$res !=\"\"} {set res [ .l.v.c.var_name get $res]; set choice 7} {}}");
...
main_cycle:
//cmd(inter, "focus -force .");
cmd(inter, "if { $listfocus == 1} {focus -force .l.v.c.var_name; .l.v.c.var_name selection set $itemfocus; .l.v.c.var_name activate $itemfocus} {}");
...
int sl, done=0, num, i, param, save, plot, nature, numlag, k;
...
cmd(inter, msg);
if(cv->param==1)
 cmd(inter, "pack .b1.sav .b1.plt -anchor w");
if(cv->param==0)
 cmd(inter, "pack .b1.deb .b1.sav .b1.plt -anchor w");
if(cv->param==2)
 cmd(inter, "pack .b1.deb .b1.sav -anchor w");
